window.ABADDON_CONFIG = {
  // v4.4.0 automation/security/external unified config: new website + legacy pages use the same values.
  ...
  botVersion: "18.9.0",
  websiteVersion: "4.4.0",

  // Backward-compatible keys used by the older full-site pages.
  version: "v18.9.0",
  status: "ONLINE",
  statusText: "ONLINE",
  statusNote: "AUTOMATION + SECURITY + EXTERNAL ALERTS · 2026-08-13",
