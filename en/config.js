window.ABADDON_CONFIG = {
  // v4.5.7 v19.0.5 rotating reaction choreography unified config: new website + legacy pages use the same values.
  ...
  botVersion: "19.0.5",
  websiteVersion: "4.5.5",

  // Backward-compatible keys used by the older full-site pages.
  version: "v19.0.5",
  status: "ONLINE",
  statusText: "ONLINE",
  statusNote: "SUPER REACTION RUNTIME HOTFIX · 2026-08-14",
