window.ABADDON_CONFIG = {
  // v5.1.1 / BOT v19.6.1 FiveM Life Server Bridge + full dashboard + English parity + live feed.
  ...
  botVersion: "19.6.1",
  websiteVersion: "5.1.1",

  // Backward-compatible keys used by the older full-site pages.
  version: "v19.6.1",
  status: "ONLINE",
  statusText: "ONLINE",
  statusNote: "FIVEM QBCORE TWO-WAY BRIDGE · CHZZK · SOOP · WEB DASHBOARD · 2026-08-15",
