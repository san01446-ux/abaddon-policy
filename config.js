window.ABADDON_CONFIG = {
  // v4.7.0 / BOT v19.2.0 full dashboard + English parity + live feed unified config.
  ...
  botVersion: "19.2.0",
  websiteVersion: "4.7.0",

  // Backward-compatible keys used by the older full-site pages.
  version: "v19.2.0",
  status: "ONLINE",
  statusText: "ONLINE",
  statusNote: "WEB FULL CONTROL · ENGLISH PARITY · LIVE FEED · 2026-08-14",
