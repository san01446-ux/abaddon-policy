...
const commands = [
  ...
  {"c": "관리", "cmd": "!테스트 · !테스트 상세", "d": "재화와 전투 상태를 바꾸지 않고 v6.4.0a 명령·별칭 충돌, 가이드 누락, 지뢰 손익, 실시간 차트, 참가형 레이스를 점검합니다."},
  ...
  {"c": "기본", "cmd": "!패치노트 · /패치노트", "d": "최신 v6.4.0a 프론티어 작전·지뢰 정산·실시간 선물 차트·참가형 미니게임 내용을 확인합니다. !업데이트와 !변경내역도 같은 기록실을 엽니다."},
  ...
  {"c": "카지노", "cmd": "!카지노", "d": "v6.4.0a 카지노 로비입니다. 결과 이미지는 사용하지 않으며 손익·배팅·승패 판정과 펫 시너지는 텍스트로 표시됩니다."},
