...
const commands = [
  {"c": "기본", "cmd": "!봇소개", "d": "공식 승인된 ABADDON의 핵심 콘텐츠·안전 기능·빠른 시작 명령을 확인합니다."},
  ...
  {"c": "관리", "cmd": "!테스트 · !테스트 상세", "d": "재화와 전투 상태를 바꾸지 않고 v6.5.1c 명령·별칭 충돌, 28종 서버리뉴얼, 카드게임, 이미지 정책를 점검합니다."},
  ...
  {"c": "기본", "cmd": "!패치노트 · /패치노트", "d": "최신 v6.5.1c 공식 승인 봇·홈페이지 고화질·서버리뉴얼 28종 테마·포커·원카드·조커잡기 패치 내용을 확인합니다. !업데이트와 !변경내역도 같은 기록실을 엽니다."},
