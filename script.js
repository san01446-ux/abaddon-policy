...
const commands = [
  ...
  {"c": "관리", "cmd": "!서버리뉴얼 적용 아포칼립스", "d": "v4.3.3.6 안전 모드에서는 대량 적용이 임시 잠금되어 미리보기만 지원합니다."},
  {"c": "관리", "cmd": "!서버리뉴얼 게임미리보기 깔끔", "d": "BOT GAME·말해라·테스트 구역의 RPG·퀴즈·도박·음악·음성 채널 정리 계획을 미리 확인합니다."},
  {"c": "관리", "cmd": "!서버리뉴얼 게임정리 깔끔", "d": "v4.3.3.6 안전 모드에서는 게임·음성 일괄 정리가 임시 잠금되어 미리보기만 지원합니다."},
...
function initSharedUI() {
  ...
  document.querySelectorAll("[data-version]").forEach((el) => { el.textContent = cfg.version || "v4.3.3.6"; });
