...
const commands = [
  ...
  {"c": "기본", "cmd": "!패치노트 · /패치노트", "d": "최신 v6.3.5 카지노·기지 패치 내용과 이전 주요 통합 패치를 확인합니다. !업데이트와 !변경내역도 같은 기록실을 엽니다."},
  ...
  {"c": "카지노", "cmd": "!카지노", "d": "v6.3.5 카지노 로비입니다. 슬롯·블랙잭·하이로우·바카라·다이스·룰렛 결과가 실제 손익과 결과 등급에 맞는 전용 이미지로 표시됩니다."},
  {"c": "카지노", "cmd": "!블랙잭 금액", "d": "일반 승리·내추럴 블랙잭·무승부·패배·버스트 결과에 맞는 카드 테이블 이미지를 표시합니다."},
  {"c": "카지노", "cmd": "!슬롯 금액", "d": "부분 일치·일반 당첨·대승·잭팟·실패·치명 실패를 실제 릴 결과와 손익 기준으로 구분합니다."},
  {"c": "카지노", "cmd": "!하이로우 금액", "d": "예측 성공·연승 현금화·최대 연승·실패를 결과 강도에 맞는 전용 이미지로 표시합니다."},
  {"c": "카지노", "cmd": "!바카라 플레이어/뱅커/타이 금액", "d": "플레이어·뱅커·타이 판정과 실제 당첨·미당첨 결과에 맞는 카드 결과 이미지를 사용합니다."},
  {"c": "카지노", "cmd": "!다이스 홀/짝/1~6 금액", "d": "숫자 적중·홀짝 적중·실패를 배당과 순손익 기준으로 분리해 표시합니다."},
  {"c": "카지노", "cmd": "!룰렛 배팅액", "d": "생존 성공과 탄환 피격을 서로 다른 전용 장면으로 표시하며 위험 단계의 손실 강도도 반영합니다."},
  {"c": "기지", "cmd": "!기지", "d": "현재 기지 단계, 시간당 생산량, 다음 업그레이드 비용과 남은 공사 시간을 단계별 이미지와 함께 확인합니다."},
