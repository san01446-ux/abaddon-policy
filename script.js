...
const commands = [
  ...
  {"c": "기본", "cmd": "!패치노트 · /패치노트", "d": "최신 v6.3.5c 무기·보물 리뉴얼, 카지노 이미지 제거, 홈페이지 핫픽스 내용을 확인합니다. !업데이트와 !변경내역도 같은 기록실을 엽니다."},
  ...
  {"c": "카지노", "cmd": "!카지노", "d": "v6.3.5c 카지노 로비입니다. 결과 이미지는 제거했으며 손익·배팅·승패 판정은 그대로 유지됩니다."},
