...
const commands = [
  {"c": "English", "cmd": "!english · !enhelp", "d": "English command categories. Existing Korean commands remain available and use the same cooldowns and saved data."},
  {"c": "English", "cmd": "!help · !commands · !botinfo · !today", "d": "Help, command search, official bot information, and daily task summary."},
  {"c": "English", "cmd": "!work · !gather · !fish · !woodcut · !mine · !dig", "d": "Life and gathering commands mapped to the existing Korean activities."},
  {"c": "English", "cmd": "!equipment · !inventory · !enhance · !craft · !repair · !scrap", "d": "Equipment, enhancement, crafting, repair, and recycling aliases."},
  {"c": "English", "cmd": "!dungeon · !battle · !regions · !explore · !raid · !worldboss", "d": "Combat, regions, raids, and world-boss aliases."},
  {"c": "English", "cmd": "!pet · !petinfo · !petevolve · !base · !buildbase · !upgradebase", "d": "Pet and base progression aliases."},
  {"c": "English", "cmd": "!minigames · !minesweeper · !cardgames · !poker · !onecard · !jokercatch", "d": "Interactive minigame and card-game aliases."},
  {"c": "English", "cmd": "!themes · !briefing · !serverrenewal · !diagnostics", "d": "Server themes, briefing, renewal, and diagnostics aliases."},
  {"c": "기본", "cmd": "!봇소개", "d": "ABADDON의 핵심 콘텐츠·안전 기능·빠른 시작 명령을 확인합니다."},
  ...
  {"c": "관리", "cmd": "!테스트 · !테스트 상세", "d": "재화와 전투 상태를 바꾸지 않고 v7.0.0 명령·별칭 충돌, 월드보스 실전/테스트 분리, 보상 큐와 이미지 정책을 점검합니다."},
  ...
  {"c": "월드보스", "cmd": "!월드보스공격", "d": "하루 최대 10회, 45초 간격으로 보스를 공격합니다. 보스별 약점, 치명타·회피·실제 반격·차등 부위 파괴와 네 단계 페이즈가 적용됩니다."},
  {"c": "월드보스", "cmd": "!월드보스기여도", "d": "현재 전투의 내 누적 피해, 공격 횟수, 순위와 수령 가능한 보상을 확인합니다."},
  {"c": "월드보스", "cmd": "!보스랭킹", "d": "현재 월드보스 서버 기여도 상위 생존자와 누적 피해량을 확인합니다."},
  {"c": "월드보스", "cmd": "!월드보스보상", "d": "완료 보상 큐에서 가장 오래된 미수령 전투의 참가·누적 피해·처치·순위 보상을 한 번만 수령합니다."},
  ...
  {"c": "월드보스", "cmd": "!월드보스보상목록", "d": "완료 보상 큐에 보관된 미수령 전투와 이미 수령한 전투 상태를 확인합니다."},
  {"c": "월드보스", "cmd": "!월드보스이력", "d": "최근 실전 월드보스 토벌 기록과 전투 결과를 확인합니다."},
  {"c": "관리", "cmd": "!월드보스테스트상태", "d": "실전 전투와 별도로 진행 중인 테스트 보스의 HP·페이즈·파괴 부위를 확인합니다."},
  {"c": "관리", "cmd": "!월드보스테스트공격", "d": "경제와 실전 통계를 변경하지 않고 테스트 보스를 공격해 약점·페이즈·부위·반격 흐름을 검증합니다."},
  {"c": "관리", "cmd": "!월드보스테스트종료", "d": "실전 월드보스에는 영향을 주지 않고 현재 test_active 테스트 전투만 종료합니다."},
  {"c": "관리", "cmd": "!월드보스리셋 보스이름", "d": "관리자가 선택한 월드보스를 새 전투 ID로 소환합니다. !월드보스소환 별칭도 유지됩니다."},
  {"c": "관리", "cmd": "!월드보스테스트 보스이름", "d": "관리자가 실전 active와 분리된 test_active 슬롯에 테스트 보스를 소환합니다. 경제·내구도·도감·보상은 변경되지 않습니다."},
  {"c": "기본", "cmd": "!패치노트 · /패치노트", "d": "최신 v7.0.0 월드보스 리빌드, 안전 보상 큐, 실전/테스트 분리, 약점·페이즈·부위 파괴·반격 실기믹과 신규 아트 내용을 확인합니다."},
