...
const commands = [
  {"c": "환경", "cmd": "!날씨", "d": "6시간 주기로 변하는 인게임 종말 날씨와 생활·전투·슬롯 희귀 결과 보정을 확인합니다."},
  ...
  {"c": "기본", "cmd": "!패치노트 · /패치노트", "d": "최신 v6.3.6 무기·보물 리뉴얼, 카지노 이미지 제거, 홈페이지 핫픽스 내용을 확인합니다. !업데이트와 !변경내역도 같은 기록실을 엽니다."},
  ...
  {"c": "카지노", "cmd": "!카지노", "d": "v6.3.6 카지노 로비입니다. 결과 이미지는 사용하지 않으며 손익·배팅·승패 판정과 펫 시너지는 텍스트로 표시됩니다."},
