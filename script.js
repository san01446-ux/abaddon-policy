...
const commands = [
  {"c": "인카운트", "cmd": "!인카운트도감", "d": "알바·땅파기·코인·채집·낚시·벌목·광산에서 발견한 버튼형 랜덤 인카운트, 오늘 조우 횟수와 보상 상한을 확인합니다."},
  {"c": "생활", "cmd": "!채집 · !낚시 · !벌목 · !광산", "d": "생활 숙련도와 스태미나 결과를 랜덤 아포칼립스 이미지로 표시하며 낮은 확률로 3버튼 선택 인카운트가 이어집니다."},
  {"c": "장비", "cmd": "!장비 · !강화 · !제작", "d": "장비 획득, 강화 단계, 성공·실패, 제작 결과에 맞는 다중 이미지 풀과 게임별 TIP을 표시합니다."},
  {"c": "생활", "cmd": "!기지 · !기지강화 · !기지수확", "d": "기지 레벨에 따라 임시 거점부터 강화된 생존 요새까지 서로 다른 성장 이미지를 표시합니다."},
  {"c": "펫", "cmd": "!펫모험 · !펫진화", "d": "펫 성장 단계에 따라 이미지가 달라지고 일부 랜덤 인카운트의 성공·회피 확률에 작은 보너스를 제공합니다."},
  ...
  {"c": "경제", "cmd": "!돈주세요", "d": "지원 교섭과 보급 상자 검사를 단계형으로 보여주며 정상 지원·빈 상자·사기 상인 결과, 증감액과 현재 잔액을 표시합니다."},
  {"c": "생활", "cmd": "!알바", "d": "작업 배정·진행·완료 또는 사고를 단계형으로 보여주고 임금·수리비·추가 자원·현재 잔액을 한눈에 표시합니다."},
  {"c": "카지노", "cmd": "!카지노", "d": "기존 슬롯·룰렛·블랙잭·하이로우·주사위·바카라·행운의바퀴·동전게임을 단계형 결과 연출로 이용합니다."},
  ...
  {"c": "관리", "cmd": "!서버리뉴얼 게임정리 깔끔", "d": "게임·음성 구역의 안전 적용 계획만 생성하고, 실제 변경은 다음 명령으로 한 단계씩 진행합니다."},
