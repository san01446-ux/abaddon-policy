...
const commands = [
  ...
  {"c": "서버", "cmd": "!서버테마 · !서버테마미리보기 [테마명]", "d": "검은 성당·폐허 도시·격리 연구소·황혼 전초기지·종말 방송국 테마를 확인합니다."},
  ...
  {"c": "관리", "cmd": "!테스트 · !테스트 상세", "d": "재화와 전투 상태를 바꾸지 않고 v6.4.1 명령·별칭 충돌, 가이드 누락, 데이터 저장, 텍스트 우선 정책를 점검합니다."},
  ...
  {"c": "기본", "cmd": "!패치노트 · /패치노트", "d": "최신 v6.4.1 안정화·텍스트 우선·서버 테마 내용을 확인합니다. !업데이트와 !변경내역도 같은 기록실을 엽니다."},
  ...
  {"c": "카지노", "cmd": "!카지노", "d": "v6.4.1 카지노 로비입니다. 결과 이미지는 사용하지 않으며 손익·배팅·승패 판정과 펫 시너지는 텍스트로 표시됩니다."},
  ...
  {"c": "기지", "cmd": "!기지", "d": "현재 기지 단계, 시간당 생산량, 다음 업그레이드 비용과 남은 공사 시간을 텍스트 상태표로 확인합니다."},
