...
const commands = [
  ...
  {"c": "관리", "cmd": "!테스트 · !테스트 상세", "d": "재화와 전투 상태를 바꾸지 않고 v6.3.7 명령·날씨·장비·카지노 이미지 제거·전투 후크를 점검합니다."},
  ...
  {"c": "기본", "cmd": "!패치노트 · /패치노트", "d": "최신 v6.3.7 변동 환경·무전·장비 정비·일일 이벤트·자체 테스트 내용을 확인합니다. !업데이트와 !변경내역도 같은 기록실을 엽니다."},
  ...
  {"c": "카지노", "cmd": "!카지노", "d": "v6.3.7 카지노 로비입니다. 결과 이미지는 사용하지 않으며 손익·배팅·승패 판정과 펫 시너지는 텍스트로 표시됩니다."},
